...
you should place your code here."
  ...
  (global-company-mode);; enable completion all around

  ;; ============================= rainbow identifiers settings ================
